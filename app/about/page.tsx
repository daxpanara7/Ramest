        ...
        <div className="container about-container">
          ...
          <div className="about-content">
            ...
            <p className="about-text">
              Ramest Technolabs is a next-generation IT company founded by{" "}
              <strong>Dax Panara</strong> in Surat, India. We specialize in
              delivering scalable software solutions — from custom web and mobile
              apps to AI/ML-powered products — for clients across the globe.
            </p>
            <p className="about-text" style={{ marginTop: "1rem" }}>
              We blend technical precision with creative thinking to build
              products that don&apos;t just work — they <em>delight</em>. Our team
              is our greatest asset, and we invest continuously in their growth,
              tools, and well-being.
            </p>
