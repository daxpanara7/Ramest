 ...
 * looks broken.
 *
 * The .stack-card wrapper lives HERE, not in page.tsx. When page.tsx owned it,
 * a zero-post build still rendered the empty card — and .stack-card's own
 * padding-top + border-top + 34px top radius drew a 9px rounded bar floating
 * above the next section. Wrapper and content must appear or vanish together.
 */
